"""Generate mitra architecture diagrams (local + cloud variants): .excalidraw + .png each."""
...
VARIANTS = {
    "local": {
        ...
        "title": "Mitra - Option A: fully local inference (offline after model download)",
        "nodes": [
